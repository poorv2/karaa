                ...
                <div class="">
                    <div class="" >
                        ...
                        <div v-if="this.walletStatus" class="container-fluid">
                                ...
                                <div class="col">
                                    ...
                                    <div v-else>
                                        <div v-if="userAirDrop.isExists" >
                                            <div style="margin-top: 20px;" class="row"><p><b>You Invited To Buy</b> {{ userAirDrop.referral_buy_index }} <b>Tpunks</b></p></div>
                                            <div class="row">
                                               <div class="col" >
                                                   <div class="row" >
                                                   ...
                                                   <div class="row" >
                                                       <p>your invite link : <a v-bind:href="'https://tpunks.com/i/' + userAirDrop.id">https://tpunks.com/i/{{ userAirDrop.id }}</a></p>
                                                   </div>
                                               </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row"><h3>Owned Tpunks <b>({{ tronPunksBalance }})</b></h3></div>
                        </div>
    ...
    methods: {
      async showData(){
          (async()=>{
              ...
              this.tronPunksBalance = this.walletManager.ttronWeb.BigNumber(bf).toNumber();
          })();
          (async()=>{
